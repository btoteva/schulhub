...
export async function createUser(sql, username, passwordHash, role = "user", email = null, school = null, className = null) {
  await sql`
...
export async function addUserChild(sql, parentUsername, childName, school, className) {
  const rows = await sql`
...
export async function updateUserChild(sql, id, parentUsername, childName, school, className) {
  await sql`
