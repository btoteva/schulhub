            ...
            {teile.map((teil) => (
              ...
              >
                <div className="flex items-start justify-between gap-4 flex-wrap mb-2">
                  <h2 className={`text-2xl font-bold ${isLight ? "text-amber-600" : "text-amber-400"}`}>
                    {teil.title}
                    {teil.subtitle && ` – ${teil.subtitle}`}
                  </h2>
                  {(teil.scenes?.length || teil.content || teil.aufgaben?.length) && (
                    <button
                      type="button"
                      onClick={() => setShowTeacherTextTeile((prev) => ({ ...prev, [teil.id]: !prev[teil.id] }))}
                      className={`p-2 rounded-lg transition-colors shrink-0 ${isLight ? "bg-amber-600/20 hover:bg-amber-600/40 text-amber-800" : "bg-amber-600/20 hover:bg-amber-600/40 text-amber-200"}`}
                ...
                {teil.content && (!hasGlobalAudio || showTeacherTextTeile[teil.id]) && (
                ...
                {teil.aufgaben && teil.aufgaben.length > 0 && (!hasGlobalAudio || showTeacherTextTeile[teil.id]) && (
                ...
                {teil.id === "teil2" && teil.teil2Exercise && (
                  <div className={`mt-10 pt-10 border-t-2 ${isLight ? "border-amber-500/40" : "border-amber-500/40"}`}>
                    ...
                    <div className={`mt-8 pt-6 border-t ${isLight ? "border-amber-500/30" : "border-amber-500/30"}`}>
                      ...
                      {showTeil2Answers && (
                        <div className="mt-6">
                          <p className={`font-bold mb-3 ${isLight ? "text-amber-800" : "text-amber-200"}`}>Teil 2: Helden des Alltags – Lösungen</p>
                ...
                {teil.id === "teil3" && teil.teil3Exercise && (
                  <div className={`mt-10 pt-10 border-t-2 ${isLight ? "border-amber-500/40" : "border-amber-500/40"}`}>
                    ...
                    <div className={`mt-8 pt-6 border-t ${isLight ? "border-amber-500/30" : "border-amber-500/30"}`}>
                      ...
                      {showTeil3Answers && (
                        <div className="mt-6">
                          <p className={`font-bold mb-3 ${isLight ? "text-amber-800" : "text-amber-200"}`}>Teil 3: Katrin in den USA – Lösungen</p>
                          <ul className={`list-disc list-inside space-y-1 ${isLight ? "text-slate-800" : "text-gray-200"}`}>
                ...
                {teil.id === "teil4" && teil.teil4Exercise && (
                  <div className={`mt-10 pt-10 border-t-2 ${isLight ? "border-amber-500/40" : "border-amber-500/40"}`}>
                    ...
                    <div className={`mt-8 pt-6 border-t ${isLight ? "border-amber-500/30" : "border-amber-500/30"}`}>
                      ...
                      {showTeil4Answers && (
                        <div className="mt-6">
                          <p className={`font-bold mb-3 ${isLight ? "text-amber-800" : "text-amber-200"}`}>Teil 4: Praktikum bei der Zeitung – Lösungen</p>
                          <ul className={`list-disc list-inside space-y-1 ${isLight ? "text-slate-800" : "text-gray-200"}`}>
                ...
                {teil.id === "teil5" && teil.teil5Exercise && (
                  <div className={`mt-10 pt-10 border-t-2 ${isLight ? "border-amber-500/40" : "border-amber-500/40"}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                      <div>
                        <p className={`font-semibold mb-4 ${isLight ? "text-amber-800" : "text-amber-200"}`}>Überschriften A–H</p>
                    ...
                    <div className={`mt-8 pt-6 border-t ${isLight ? "border-amber-500/30" : "border-amber-500/30"}`}>
                      ...
                      {showTeil5Answers && (
                        <div className="mt-6">
                          <p className={`font-bold mb-3 ${isLight ? "text-amber-800" : "text-amber-200"}`}>Teil 5: Kurznachrichten – Lösungen</p>
                          <ul className={`list-disc list-inside space-y-1 ${isLight ? "text-slate-800" : "text-gray-200"}`}>
                            {teil.teil5Exercise.taskNumbers.map((nr) => (
...
export default DSDHorverstehen8View;
