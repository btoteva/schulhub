...
const DSDModellsatz8View: React.FC = () => {
          ...
          <section className="mt-12 p-6 rounded-xl border-2 border-amber-500/50 bg-amber-900/10">
            ...
            {showAnswerKey && data.teile.length > 0 && (
              <div className="mt-8 p-6 bg-slate-200 dark:bg-gray-900/80 rounded-xl border border-amber-500/30 text-left">
                <h3 className="text-xl font-bold text-amber-600 dark:text-amber-400 mb-6">Deutsches Sprachdiplom der KMK DSD I – Leseverstehen Lösungsschlüssel (Modellsatz 8)</h3>
...
export default DSDModellsatz8View;
