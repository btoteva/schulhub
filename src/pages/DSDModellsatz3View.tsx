        ...
        <div className="space-y-12">
            ...
            <section className="bg-gray-800/50 rounded-xl p-8 border border-amber-500/30">
              ...
              {teil1.aufgabe5 && (
                <div className="mt-4 p-6 bg-gray-700/50 rounded-lg">
                  <p className="font-semibold text-amber-200 mb-4">{teil1.aufgabe5.question}</p>
          ...
          {teil2 && teil2.summaries && teil2.emailOptions && (
            <section className="bg-gray-800/50 rounded-xl p-8 border border-amber-500/30">
              ...
              <h3 className="text-lg font-semibold text-amber-200 mb-3">{(teil2 as { optionsHeading?: string }).optionsHeading || "E-Mails A–H"}</h3>
          ...
          <section className="mt-12 p-6 rounded-xl border-2 border-amber-500/50 bg-amber-900/10">
            ...
            {showAnswerKey && (
              <div className="mt-8 p-6 bg-gray-900/80 rounded-xl border border-amber-500/30 text-left">
                <h3 className="text-xl font-bold text-amber-400 mb-6">Deutsches Sprachdiplom der KMK DSD I – Leseverstehen Lösungsschlüssel (Modellsatz 3)</h3>
                <div className="space-y-5 text-gray-300 text-sm leading-relaxed">
                  ...
                  {hasTeil2 && (
                    <div>
                      <p className="font-semibold text-amber-200 mb-1">Teil 2: Wer macht mit?</p>
                      <p>6 B &nbsp;&nbsp; 7 H &nbsp;&nbsp; 8 E &nbsp;&nbsp; 9 G</p>
                    </div>
                  )}
                  {hasTeil3 && (
                    <div>
                      <p className="font-semibold text-amber-200 mb-1">Teil 3: Kreativer Unterricht – Wo spielt die Musik?</p>
                      <p>10 richtig &nbsp;&nbsp; 11 falsch &nbsp;&nbsp; 12 richtig &nbsp;&nbsp; 13 richtig &nbsp;&nbsp; 14 falsch</p>
                    </div>
                  )}
                  {hasTeil4 && (
                    <div>
                      <p className="font-semibold text-amber-200 mb-1">Teil 4: Ein Schuljahr in Australien</p>
