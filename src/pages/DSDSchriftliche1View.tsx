    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white">
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-amber-400">DSD I Modellsatz 1</h1>
          <p className="text-gray-400 mt-1">Schriftliche Kommunikation – Hausaufgaben</p>
        </header>
        ...
        <section className="bg-gray-800/40 rounded-xl p-8 border border-amber-500/30">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            <div className="p-5 rounded-xl bg-gray-900/60 border border-amber-500/20">
              <p className="text-amber-300 font-semibold mb-2">Tim</p>
            ...
            <div className="p-5 rounded-xl bg-gray-900/60 border border-amber-500/20 rounded-bl-3xl">
              <p className="text-amber-300 font-semibold mb-2">Laura</p>
              <p className="text-gray-200 text-sm leading-relaxed">
            ...
            <div className="p-5 rounded-xl bg-gray-900/60 border border-amber-500/20 rounded-bl-3xl">
              <p className="text-amber-300 font-semibold mb-2">Klara</p>
              <p className="text-gray-200 text-sm leading-relaxed">
            ...
            <div className="p-5 rounded-xl bg-gray-900/60 border border-amber-500/20">
              <p className="text-amber-300 font-semibold mb-2">Peter</p>
              <p className="text-gray-200 text-sm leading-relaxed">
